...
function __fish_moon_global_optspecs
	string join \n C/directory= target-dir= q/quiet v/verbose trace dry-run build-graph Z/unstable-feature= h/help
end
...
complete -c moon -n "__fish_moon_using_subcommand test" -s i -l index -d 'Run only the index-th test in the file. Only valid when `--file` is also specified. Implies `--include-skipped`' -r
...
complete -c moon -n "__fish_moon_using_subcommand fetch" -s C -l directory -d 'The source code directory. Defaults to the current directory' -r -F
complete -c moon -n "__fish_moon_using_subcommand fetch" -l target-dir -d 'The target directory. Defaults to `source_dir/target`' -r -F
...
complete -c moon -n "__fish_moon_using_subcommand coverage; and not __fish_seen_subcommand_from analyze report clean help" -s C -l directory -d 'The source code directory. Defaults to the current directory' -r -F
complete -c moon -n "__fish_moon_using_subcommand coverage; and not __fish_seen_subcommand_from analyze report clean help" -l target-dir -d 'The target directory. Defaults to `source_dir/target`' -r -F
...
complete -c moon -n "__fish_moon_using_subcommand coverage; and __fish_seen_subcommand_from analyze" -s C -l directory -d 'The source code directory. Defaults to the current directory' -r -F
complete -c moon -n "__fish_moon_using_subcommand coverage; and __fish_seen_subcommand_from analyze" -l target-dir -d 'The target directory. Defaults to `source_dir/target`' -r -F
...
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -s C -l directory -d 'The source code directory. Defaults to the current directory' -r -F
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -l target-dir -d 'The target directory. Defaults to `source_dir/target`' -r -F
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -s q -l quiet -d 'Suppress output'
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -s v -l verbose -d 'Increase verbosity'
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -l trace -d 'Trace the execution of the program'
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -l dry-run -d 'Do not actually run the command'
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -l build-graph
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -s h -l help -d 'Print help'
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -f -a "format-and-diff" -d 'Format the code and print the difference'
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -f -a "embed"
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -f -a "write-tcc-rsp-file"
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -f -a "build-binary-dep"
complete -c moon -n "__fish_moon_using_subcommand tool; and not __fish_seen_subcommand_from format-and-diff embed write-tcc-rsp-file build-binary-dep help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c moon -n "__fish_moon_using_subcommand tool; and __fish_seen_subcommand_from write-tcc-rsp-file" -s C -l directory -d 'The source code directory. Defaults to the current directory' -r -F
complete -c moon -n "__fish_moon_using_subcommand tool; and __fish_seen_subcommand_from write-tcc-rsp-file" -l target-dir -d 'The target directory. Defaults to `source_dir/target`' -r -F
...
complete -c moon -n "__fish_moon_using_subcommand tool; and __fish_seen_subcommand_from build-binary-dep" -s C -l directory -d 'The source code directory. Defaults to the current directory' -r -F
complete -c moon -n "__fish_moon_using_subcommand tool; and __fish_seen_subcommand_from build-binary-dep" -l target-dir -d 'The target directory. Defaults to `source_dir/target`' -r -F
...
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "new" -d 'Create a new MoonBit module'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "bundle" -d 'Bundle the module'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "build" -d 'Build the current package'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "check" -d 'Check the current package, but don\'t build object files'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "run" -d 'Run a main package'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "test" -d 'Test the current package'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "generate-test-driver" -d 'Generate tests for a provided package. This is a thin wrapper around `moonc gen-test-info`, which does the actual parsing and generation'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "clean" -d 'Remove the target directory'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "fmt" -d 'Format source code'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "doc" -d 'Generate documentation or searching documentation for a symbol'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "info" -d 'Generate public interface (`.mbti`) files for all packages in the module'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "bench" -d 'Run benchmarks in the current package'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "add" -d 'Add a dependency'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "remove" -d 'Remove a dependency'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "install" -d 'Install dependencies'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "tree" -d 'Display the dependency tree'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "fetch" -d 'Download a package to .repos directory (unstable)'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "login" -d 'Log in to your account'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "register" -d 'Register an account at mooncakes.io'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "publish" -d 'Publish the current module'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "package" -d 'Package the current module'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "update" -d 'Update the package registry index'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "coverage" -d 'Code coverage utilities'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "generate-build-matrix" -d 'Generate build matrix for benchmarking (legacy feature)'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "query"
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "upgrade" -d 'Upgrade toolchains'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "shell-completion" -d 'Generate shell completion for bash/elvish/fish/pwsh/zsh to stdout'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "version" -d 'Print version information and exit'
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "tool"
complete -c moon -n "__fish_moon_using_subcommand help; and not __fish_seen_subcommand_from new bundle build check run test generate-test-driver clean fmt doc info bench add remove install tree fetch login register publish package update coverage generate-build-matrix query upgrade shell-completion version tool help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
